        ...
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-amber-500 via-orange-500 to-red-500 p-8 text-white">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-white/80 text-sm font-medium">Resume Examples Library</span>
            </div>
            <h1 className="text-3xl lg:text-4xl font-bold mb-2">
              Professional Resume Examples
            </h1>
            <p className="text-white/80 text-lg max-w-2xl">
              Browse our collection of professionally written resume examples. Get inspired by real
              resume content and copy bullet points directly to your resume.
            </p>
          </div>
        </div>
              ...
              >
                <CardContent className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-amber-100 to-orange-100 rounded-xl flex items-center justify-center text-amber-600">
